...
class BaseSprite(pygame.sprite.Sprite):
    def __init__(self, game, x, y, x_pos=0, y_pos=0, width=16, height=21, layer=0,
                 groups=None, spritesheet=None):
        self._layer = layer
        groups = (game.all_sprites,) if groups is None else (game.all_sprites, groups)
...
class PlayerSprite(BaseSprite):
    ...
    def handle_movement(self):
        ...
        if keys[pygame.K_RIGHT]:
            if self.rect.right + self.speed < Config.WINDOW_WIDTH:
...
class Game:
    def __init__(self):
        ...
        self.bg = pygame.image.load("res/background.png").convert()
    ...
    def game_over(self):
        ...
        score_text = self.font2.render(f"Your score: {self.player.score}", True, (255, 255, 255))
    ...
    def welcome(self):
        ...
        press_text = self.font2.render('Press any key to start', False, (255, 204, 204))
